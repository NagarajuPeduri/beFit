...
package de.j4velin.be_fit.widget;

import de.j4velin.be_fit.ui.Activity_Main;
...
public class Widget extends AppWidgetProvider {
	...
	static RemoteViews updateWidget(final int appWidgetId, final Context context, final int steps) {
		...
		views.setTextColor(R.id.widgetsteps, prefs.getInt("color_" + appWidgetId, Color.BLACK));
		views.setTextViewText(R.id.widgetsteps, String.valueOf(steps));
		views.setTextColor(R.id.widgettext, prefs.getInt("color_" + appWidgetId, Color.BLACK));
